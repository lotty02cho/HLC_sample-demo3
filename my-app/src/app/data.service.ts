...
export class DataService<Type> {
    ...
    public getTransaction(): Observable<Type[]> {
        console.log('GetTransaction http://localhost:3000/api/system/transactions');
        return this.http.get(`http://localhost:3000/api/system/transactions`)
